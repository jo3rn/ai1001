...
TEST(BubbleSortTestSuite, EmptyArray) {
  int arr[] = {};
  int nExp = 0;
  bubbleSort(arr, nExp);
...
TEST(BubbleSortTestSuite, SingleItem) {
  int arr[] = {1};
  int nExp = 1;
  bubbleSort(arr, nExp);
...
TEST(BubbleSortTestSuite, TwoItems) {
  int expArr[] = {1, 2};
  int actArr[] = {2, 1};
  bubbleSort(actArr, 2);
  ...
  int i;
  for (i = 0; i < nAct; i++) {
    ASSERT_EQ(actArr[i], expArr[i]) << "fails with two items";
  }
}

TEST(BubbleSortTestSuite, ThreeIdenticalItems) {
  int expArr[] = {2, 2, 2};
  int nExp = 3;
  int actArr[] = {2, 2, 2};
  bubbleSort(actArr, nExp);
...
TEST(BubbleSortTestSuite, NegativeItems) {
  int expArr[] = {-5, -1, 7};
  int nExp = 3;
  int actArr[] = {7, -1, -5};
  bubbleSort(actArr, nExp);
  ...
  int i;
  for (i = 0; i < nExp; i++) {
    ASSERT_EQ(actArr[i], expArr[i]) << "fails with negative items";
  }
}

TEST(BubbleSortTestSuite, LargeIntegers) {
  int expArr[] = {-2147483648, 0, 55555555, 2147483647};
  int nExp = 4;
  int actArr[] = {2147483647, 55555555, -2147483648, 0};
  bubbleSort(actArr, nExp);
  ...
  int i;
  for (i = 0; i < nExp; i++) {
    ASSERT_EQ(actArr[i], expArr[i]) << "fails with large integers";
  }
}